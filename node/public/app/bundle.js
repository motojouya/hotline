...
exports.default = function (win, doc, hstry, loc, xhr, getStore, bodyTag, riot, pause) {
  ...
  var transfer = function transfer(pathname) {
  ...
  var sendWSMessage = function sendWSMessage(message, confirm) {
    wsConn.send({
      message: message,
      confirm: confirm
    });
  ...
  var replaceInitialState = function replaceInitialState(pathname) {
...
var relations = [{ relation_no: 1, userid: "hamada", name: "浜田", is_applicant: true, color: "313", status: "ACTIVE", message: "2017-07-01 12:34:56", call: "2017-06-17 11:21:45" }, { relation_no: 2, userid: "takasu", name: "高須", is_applicant: false, color: "291", status: "PENDING", message: "2017-04-09 23:12:21", call: null }];
...
exports.default = function (observable) {
  ...
  var getRelation = function getRelation(relation_no) {
  ...
  var getVoices = function getVoices(relation_no) {
    var voices;
  ...
  var setVoices = function setVoices(relation_no, ary) {
    var voices,
        i = 0,
        len = ary.length;
