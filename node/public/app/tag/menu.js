riot.tag2('menu', '<div class="titlebar"> <h3 class="title">PSPS</h3> <span class="configlink"><a href="/app/config/" onclick="{move}">設定</a></span> </div> <ul class="userlist"> <li> <a href="/app/relation" onclick="{move}">+つながる</a> </li> <li class="relateduser" each="{relationAry}"> <a href="/app/relation/{userid}/" onclick="{parent.move}">{name}</a> </li> </ul>', 'menu .titlebar,[data-is="menu"] .titlebar{ } menu .title,[data-is="menu"] .title{ display: inline-block; } menu .configlink,[data-is="menu"] .configlink{ } menu .userlist,[data-is="menu"] .userlist{ list-style: none; } menu .relateduser,[data-is="menu"] .relateduser{ }', '', function(opts) {
