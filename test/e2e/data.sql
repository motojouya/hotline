INSERT INTO users (userid      ,email                 ,name       ,countersign,active,color,notification,registered_at,thumbnail          )
           VALUES ('testuser01','testuser01@gmail.com','試験 零一','cs01'     ,TRUE  ,'7e7','UNLESS'    ,now()        ,'/app/img/test.jpg')
                , ('testuser02','testuser02@gmail.com','試験 零二','cs02'     ,TRUE  ,'7e7','UNLESS'    ,now()        ,'/app/img/test.jpg')
                , ('testuser03','testuser03@gmail.com','試験 零三','cs03'     ,TRUE  ,'e77','ALWAYS'    ,now()        ,'/app/img/test.jpg')
                , ('testuser04','testuser04@gmail.com','試験 零四','cs04'     ,TRUE  ,'7e7','UNLESS'    ,now()        ,'/app/img/test.jpg')
                , ('testuser05','testuser05@gmail.com','試験 零五','cs05'     ,TRUE  ,'7e7','UNLESS'    ,now()        ,'/app/img/test.jpg')
                , ('testuser06','testuser06@gmail.com','試験 零六','cs06'     ,TRUE  ,'7e7','UNLESS'    ,now()        ,'/app/img/test.jpg')
                , ('testuser07','testuser07@gmail.com','試験 零七','cs07'     ,TRUE  ,'7e7','UNLESS'    ,now()        ,'/app/img/test.jpg')
                , ('testuser08','testuser08@gmail.com','試験 零八','cs08'     ,TRUE  ,'7e7','UNLESS'    ,now()        ,'/app/img/test.jpg')
                , ('testuser09','testuser09@gmail.com','試験 零九','cs09'     ,TRUE  ,'7e7','UNLESS'    ,now()        ,'/app/img/test.jpg')
                , ('testuser10','testuser10@gmail.com','試験 一零','cs10'     ,TRUE  ,'7e7','UNLESS'    ,now()        ,'/app/img/test.jpg')
                , ('testuser11','testuser11@gmail.com','試験 一一','cs11'     ,TRUE  ,'7e7','UNLESS'    ,now()        ,'/app/img/test.jpg')
                , ('testuser12','testuser12@gmail.com','試験 一二','cs12'     ,TRUE  ,'7e7','UNLESS'    ,now()        ,'/app/img/test.jpg')
                , ('testuser13','testuser13@gmail.com','試験 一三','cs13'     ,TRUE  ,'7e7','UNLESS'    ,now()        ,'/app/img/test.jpg')
                , ('testuser14','testuser14@gmail.com','試験 一四','cs14'     ,TRUE  ,'7e7','UNLESS'    ,now()        ,'/app/img/test.jpg')
                , ('testuser15','testuser15@gmail.com','試験 一五','cs15'     ,TRUE  ,'7e7','UNLESS'    ,now()        ,'/app/img/test.jpg')
                , ('testuser16','testuser16@gmail.com','試験 一六','cs16'     ,TRUE  ,'7e7','UNLESS'    ,now()        ,'/app/img/test.jpg')
                , ('testuser17','testuser17@gmail.com','試験 一七','cs17'     ,TRUE  ,'7e7','UNLESS'    ,now()        ,'/app/img/test.jpg')
                , ('testuser18','testuser18@gmail.com','試験 一八','cs18'     ,TRUE  ,'7e7','UNLESS'    ,now()        ,'/app/img/test.jpg')
                , ('testuser19','testuser19@gmail.com','試験 一九','cs19'     ,TRUE  ,'7e7','UNLESS'    ,now()        ,'/app/img/test.jpg');
